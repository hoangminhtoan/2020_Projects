...
class RegressionModel(nn.Module):
    def __init__(self, num_features_in, num_anchors=9, feature_size=256):
        ...
        self.bn_output = nn.BatchNorm2d(num_anchors * 4)
...
class AttentionModel(nn.Module):
    ...
    def __init__(self, num_features_in, feature_size=256):
        ...
        self.output = nn.Conv2d(feature_size, 1, kernel_size=3, padding=1)
...
class ResNet(nn.Module):
    ...
    def __init__(self, num_classes, block, layers):
        ...
        self.attentionModel.output.weight.data.fill_(0)
        self.attentionModel.output.bias.data.fill_(0)
    ...
    def forward(self, inputs):
        ...
        if self.training:
            ...
            mask_loss = self.attentionLoss(img_batch.shape, attention, annotations)
